...
- Giant reputation ladder derives persisted score/rank from accepted trophy events (including escape-failure trophies on `escaped` custody ends); realm owner debug attributes expose score, rank, and rank title.
