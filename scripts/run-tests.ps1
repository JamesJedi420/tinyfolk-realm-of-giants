...
$testFiles = @(
    ...
    'tests\published_client_teleport_evidence_caller.spec.luau',
	...
	'tests\capture_persistence_rules.spec.luau',
    ...
    'tests\tin_food_economy_farm_granary_runtime_entrypoint.spec.luau',
    'tests\tin_food_construction_spend_runtime_entrypoint.spec.luau',
    'tests\pen_rationing_state.spec.luau',
    'tests\pen_rationing_service_runtime_entrypoint.spec.luau',
    'tests\tin_food_pen_rationing_runtime_entrypoint.spec.luau',
    ...
    'tests\notification_dropped_message_harness.spec.luau',
    ...
    'tests\party_matchmaking_queue_state.spec.luau',
    'tests\party_matchmaking_queue_service_runtime_entrypoint.spec.luau',
    'tests\party_matchmaking_hub_service_runtime_entrypoint.spec.luau',
    ...
    'tests\tinyfolk_haul_logistics_state.spec.luau',
    'tests\tinyfolk_haul_logistics_service_runtime_entrypoint.spec.luau',
    'tests\tinyfolk_labor_job_hud_presentation.spec.luau',
    'tests\tinyfolk_inspect_state.spec.luau',
    'tests\tinyfolk_inspect_presentation.spec.luau',
